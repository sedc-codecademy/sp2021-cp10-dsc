import quizesSvg from "../img-avatars/quizzes.svg";
...
export const AnimationsService = {
  ...
  headerAnimation: function () {
    ...
    if (window.innerWidth < 821) {
      ...
      this.avatarImgDiv.addEventListener("animationend", (e) => {
      ...
      this.chatQuizzes.addEventListener("animationend", () => {
        ...
        this.chatQuizzes.innerHTML = `<img src="${quizesSvg}" height="25rem">`;
      });
    }
  },
