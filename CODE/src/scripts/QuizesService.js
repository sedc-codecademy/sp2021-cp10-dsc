...
export const QuizzesService = {
  ...
  printQuizzesMenu: function () {
    AnimationsService.chatQuizzes.addEventListener("click", function () {
      ...
      QuizzesService.areQuizzesOpen = UiService.changeFlag(
        QuizzesService.areQuizzesOpen
      );
      ...
      for (let quiz in DataService.cachedQuizzes.Quizzes) {
        quizzesInnerHTML += `<button id="${quiz}" class="btnCard" onclick="QuizzesService.getQuiz(
          "${quiz}"
        )">
                        <div class="btnCardName">${quiz.replace(
                          /-/g,
                          " "
                        )}</div>
                        <div class="btnCardDescription">${
