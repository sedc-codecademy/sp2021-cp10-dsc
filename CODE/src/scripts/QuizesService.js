const QuizzesService = {
    ...
    printQuizzesMenu: function () {
        ...
        AnimationsService.chatQuizzes.addEventListener('click', function () {
            ...
            // UiService.toggleDisplayView(AnimationsService.chatWindow, QuizzesService.gamesAndQuizzesWindow);
            ...
            if (!QuizzesService.areQuizzesOpen) return;

            QuizzesService.gamesAndQuizzesWindow.innerHTML = "";

            QuizzesService.gamesAndQuizzesWindow.innerHTML += `<p id="quizesMessage">Choose a Quiz</p>
            <hr class="chat-js-hr">`;

            QuizzesService.gamesAndQuizzesWindow.innerHTML += `<button id="webDevelopmentQuiz" class="btn">Web Development Quiz</button>
    ...
    checkRightAnswers: function (questions) {
        return new Promise((resolve, reject) => {
            ...
            console.log(DataService.cachedData);
