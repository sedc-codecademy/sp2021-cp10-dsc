...
import { RepliesService } from "./RepliesService";
...
export const DataService = {
  ...
  cachedQuizzes: QuizzesService && QuizzesService.getQuizzesData(),
  ...
  getDataAsync: async function () {
    try {
      ...
      let response = await fetch(
        `https://dev.sedc.mk/wp-json/wp/v2/pages/4167?fbclid=IwAR0GF8p_JPAi40bfL22FNQUiTcR3q7W8e_nbn99VZhCI0cYx7cGyAeyZNKk/`
      );
      ...
      AnimationsService.chatWindow.innerHTML = `<div id="errorWrapper" class="errorWrapper"> <img src="./src/img-avatars/errorImage.png" alt="Error Img">
  ...
  serializeData: function (data) {
    return {
      ...
      timeline: `The academy duration is ${
        data.ACF.length_in_month
      }.\n${data.ACF["timeline-skopje"].map((x) => x.skopje).join(",\n")}.`,
      trainers: data.ACF.trainers,
      infoProperties: ["Overview", "Timeline", "Trainers", "Apply", "Price"],
    };
  },
